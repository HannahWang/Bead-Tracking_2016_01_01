...
% Size of subvolume containing a bead (sould be odd)
cfg.xsize=9;
cfg.ysize=9;
cfg.zsize=3;
...
% CCD camera offset (darkness; was 200)
cfg.CCDoffset=8;

% Threshold for identification of bead candidates (was 10)
cfg.beadCandidateThreshold=5;
...
% central intensity. Set to Inf to disable (was 0.7)
cfg.goodBeadThreshold=0.8;
...
cfg.scale_Px2muM=[0.17 .17 1];   % was 645E-3 645E-3 527*3.8E-3
